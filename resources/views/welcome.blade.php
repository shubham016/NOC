...
<head>
    ...
    <style>
        ...
        *,:after,:before{box-sizing:border-box;border:0 solid #e2e8f0}a{color:inherit;text-decoration:inherit}
        ...
        /* FIXED: Removed invalid vertical-align + made responsive */
        svg, video {
            display: block;
            max-width: 100%;
            height: auto;
        ...
        .shadow{--tw-shadow:0 1px 3px 0 rgb(0 0 0/.1),0 1px 2px -1px rgb(0 0 0/.1);box-shadow:var(--tw-shadow)}
...
<body class="antialiased">
    <div class="relative flex items-top justify-center min-h-screen bg-gray-100 dark:bg-gray-900 sm:items-center py-4 sm:pt-0">
        ...
        <div class="max-w-6xl mx-auto sm:px-6 lg:px-8">
            ...
            <!-- Rest of the welcome content (unchanged) -->
            <div class="mt-8 bg-white dark:bg-gray-800 overflow-hidden shadow sm:rounded-lg">
                <div class="grid grid-cols-1 md:grid-cols-2">
                    ...
                    <!-- Laracasts, Laravel News, Ecosystem -->
                    <!-- (All other cards unchanged – keeping brevity) -->
                    ...
                    <!-- Laravel News & Ecosystem cards – unchanged -->
                </div>
            </div>
