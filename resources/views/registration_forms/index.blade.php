        ...
        <div class="card-body">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="btn-group btn-group-sm">
                                            <a href="{{ route('registration-forms.show', $form->id) }}" class="btn btn-info" title="View">
                                                <i class="fas fa-eye"></i>
                                            </a>
                                            <a href="{{ route('registration-forms.edit', $form->id) }}" class="btn btn-warning" title="Edit">
                                                <i class="fas fa-edit"></i>
                                            </a>
                                            <form action="{{ route('registration-forms.destroy', $form->id) }}" method="POST" class="d-inline"
            ...
            @else
                <div class="alert alert-info text-center">
                    ...
                    <a href="{{ route('registration-forms.create') }}" class="alert-link">Create first registration</a>
                </div>
            @endif
        </div>
    </div>
