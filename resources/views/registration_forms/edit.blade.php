...
<div class="container my-5">
    <div class="card shadow-lg border-0">
        <div class="card-header bg-primary text-white text-center py-4">
            <h3 class="mb-0 fw-bold">NOC | Edit Employee Registration Form</h3>
        </div>
        <div class="card-body p-5">
            ...
            <form action="{{ route('registration-forms.update', $registrationForm->id) }}" method="POST" enctype="multipart/form-data" id="registrationForm">
                @csrf
                @method('PUT')
               ...
               {{-- STEP 1: Personal Info --}}
                <div class="step active" id="step1">
                    ...
                    <div class="row mb-3">
                        <div class="col-md-6">
                            ...
                            <input type="text" name="name" id="name" class="form-control" value="{{ old('name', $registrationForm->name) }}" required>
                        </div>
                        <div class="col-md-3">
                            <label for="birth_date_ad" class="form-label">Birth Date (A.D) <span class="text-danger">*</span> <small>(जन्म मिति A.D)</small></label>
                            <input type="date" name="birth_date_ad" id="birth_date_ad" class="form-control" value="{{ old('birth_date_ad', $registrationForm->birth_date_ad ? \Carbon\Carbon::parse($registrationForm->birth_date_ad)->format('Y-m-d') : '') }}" required>
                        </div>
                        <div class="col-md-3">
                            <label for="birth_date_bs" class="form-label">Birth Date (B.S) <span class="text-danger">*</span> <small>(जन्म मिति B.S)</small></label>
                            <input type="text" name="birth_date_bs" id="birth_date_bs" class="form-control" placeholder="YYYY-MM-DD" value="{{ old('birth_date_bs', $registrationForm->birth_date_bs) }}" required>
                        </div>
                    </div>
                    ...
                    <div class="row mb-3">
                        <div class="col-md-4">
                            ...
                            <input type="number" name="age" id="age" class="form-control" min="0" value="{{ old('age', $registrationForm->age) }}" required>
                        </div>
                        <div class="col-md-4">
                            <label for="phone" class="form-label">Phone <span class="text-danger">*</span> <small>(फोन नम्बर)</small></label>
                            <input type="text" name="phone" id="phone" class="form-control" value="{{ old('phone', $registrationForm->phone) }}" required>
                        </div>
                        <div class="col-md-4">
                            ...
                            <select name="gender" id="gender" class="form-select" required>
                                ...
                                <option value="Male" {{ old('gender', $registrationForm->gender) == 'Male' ? 'selected' : '' }}>Male / पुरुष</option>
                                <option value="Female" {{ old('gender', $registrationForm->gender) == 'Female' ? 'selected' : '' }}>Female / महिला</option>
                                <option value="Other" {{ old('gender', $registrationForm->gender) == 'Other' ? 'selected' : '' }}>Other / अन्य</option>
                            </select>
                        </div>
                    </div>
                    ...
                    <div class="row mb-3">
                        <div class="col-md-4">
                            ...
                            <select name="marital_status" id="marital_status" class="form-select" required>
                                ...
                                <option value="Single" {{ old('marital_status', $registrationForm->marital_status) == 'Single' ? 'selected' : '' }}>Single</option>
                                <option value="Married" {{ old('marital_status', $registrationForm->marital_status) == 'Married' ? 'selected' : '' }}>Married</option>
                                <option value="Divorced" {{ old('marital_status', $registrationForm->marital_status) == 'Divorced' ? 'selected' : '' }}>Divorced</option>
                                <option value="Widowed" {{ old('marital_status', $registrationForm->marital_status) == 'Widowed' ? 'selected' : '' }}>Widowed</option>
                            </select>
                        </div>
                        <div class="col-md-4">
                    ...
                    <div class="col-md-4">
                        ...
                        <div class="col-md-4">
                            ...
                            <input type="text" name="grandfather_name_english" id="grandfather_name_english" class="form-control" value="{{ old('grandfather_name_english', $registrationForm->grandfather_name_english) }}" required>
                        </div>
                    </div>
                    ...
                    <div class="row mb-3">
                        <div class="col-md-4">
                            ...
                            <input type="text" name="father_qualification" id="father_qualification" class="form-control" value="{{ old('father_qualification', $registrationForm->father_qualification) }}" required>
                        </div>
                        <div class="col-md-4">
                    ...
                    <div class="row mb-3">
                        <div class="col-md-4">
                            ...
                            <input type="text" name="blood_group" id="blood_group" class="form-control" value="{{ old('blood_group', $registrationForm->blood_group) }}" required>
                        </div>
                        <div class="col-md-4">
                            <label for="nationality" class="form-label">Nationality <span class="text-danger">*</span></label>
                            <input type="text" name="nationality" id="nationality" class="form-control" value="{{ old('nationality', $registrationForm->nationality) }}" required>
                        </div>
                        <div class="col-md-4">
                            ...
                            <select name="noc_employee" id="noc_employee" class="form-select" required>
                                <option value="">-- Select --</option>
                                <option value="yes" {{ old('noc_employee', $registrationForm->noc_employee) == 'yes' ? 'selected' : '' }}>Yes</option>
                                <option value="no" {{ old('noc_employee', $registrationForm->noc_employee) == 'no' ? 'selected' : '' }}>No</option>
                            </select>
                        </div>
                    </div>
                ...
                <div class="step d-none" id="step2">
                    ...
                    <div class="row mb-3">
                        <div class="col-md-4">
                            ...
                            <select name="religion" id="religion" class="form-select" required>
                                <option value="">-- Select --</option>
                                <option value="Hindu" {{ old('religion', $registrationForm->religion) == 'Hindu' ? 'selected' : '' }}>Hindu / हिन्दू</option>
                                <option value="Buddhist" {{ old('religion', $registrationForm->religion) == 'Buddhist' ? 'selected' : '' }}>Buddhist / बौद्ध</option>
                                <option value="Christian" {{ old('religion', $registrationForm->religion) == 'Christian' ? 'selected' : '' }}>Christian / ख्रीष्टिय</option>
                                <option value="Muslim" {{ old('religion', $registrationForm->religion) == 'Muslim' ? 'selected' : '' }}>Muslim / मुस्लिम</option>
                                <option value="Other" {{ old('religion', $registrationForm->religion) == 'Other' ? 'selected' : '' }}>Other / अन्य</option>
                            </select>
                            <input type="text" name="religion_other" id="religion_other" class="form-control mt-2 d-none" placeholder="If other, specify" value="{{ old('religion_other', $registrationForm->religion_other) }}">
                        </div>
                        <div class="col-md-4">
                            ...
                            <select name="community" id="community" class="form-select" required>
                                <option value="">-- Select --</option>
                                <option value="Male" {{ old('community', $registrationForm->community) == 'Male' ? 'selected' : '' }}>पुरुष</option>
                                <option value="Female" {{ old('community', $registrationForm->community) == 'Female' ? 'selected' : '' }}>महिला</option>
                                <option value="LGBTQ" {{ old('community', $registrationForm->community) == 'LGBTQ' ? 'selected' : '' }}>LGBTQ+</option>
                                <option value="Other" {{ old('community', $registrationForm->community) == 'Other' ? 'selected' : '' }}>Other / अन्य</option>
                            </select>
                            <input type="text" name="community_other" id="community_other" class="form-control mt-2 d-none" placeholder="If other, specify" value="{{ old('community_other', $registrationForm->community_other) }}">
                        </div>
                        <div class="col-md-4">
                            ...
                            <select name="ethnic_group" id="ethnic_group" class="form-select" required>
                                <option value="">-- Select --</option>
                                <option value="Dalit" {{ old('ethnic_group', $registrationForm->ethnic_group) == 'Dalit' ? 'selected' : '' }}>Dalit</option>
                                <option value="Janajati" {{ old('ethnic_group', $registrationForm->ethnic_group) == 'Janajati' ? 'selected' : '' }}>Janajati</option>
                                <option value="Madhesi" {{ old('ethnic_group', $registrationForm->ethnic_group) == 'Madhesi' ? 'selected' : '' }}>Madhesi</option>
                                <option value="Brahmin/Chhetri" {{ old('ethnic_group', $registrationForm->ethnic_group) == 'Brahmin/Chhetri' ? 'selected' : '' }}>Brahmin / Chhetri</option>
                                <option value="Other" {{ old('ethnic_group', $registrationForm->ethnic_group) == 'Other' ? 'selected' : '' }}>Other</option>
                            </select>
                            <input type="text" name="ethnic_group_other" id="ethnic_group_other" class="form-control mt-2 d-none" placeholder="If other, specify" value="{{ old('ethnic_group_other', $registrationForm->ethnic_group_other) }}">
                        </div>
                    </div>
                    ...
                    <div class="row mb-3">
                       <div class="col-md-6">
                        ...
                        <div class="col-md-4">
                            ...
                            <input type="text" name="mother_tongue" id="mother_tongue" class="form-control" value="{{ old('mother_tongue', $registrationForm->mother_tongue) }}" required>
                        </div>
                        <div class="col-md-4">
                            ...
                            <select name="employment_status" id="employment_status" class="form-select" required>
                                <option value="">-- Select --</option>
                                <option value="employed" {{ old('employment_status', $registrationForm->employment_status) == 'employed' ? 'selected' : '' }}>Employed</option>
                                <option value="unemployed" {{ old('employment_status', $registrationForm->employment_status) == 'unemployed' ? 'selected' : '' }}>Unemployed</option>
                            </select>
                        </div>
                    </div>
                    ...
                    <div class="row mb-3">
                        <div class="col-md-4">
                            ...
                            <input type="text" name="employment_other" id="employment_other" class="form-control" value="{{ old('employment_other', $registrationForm->employment_other) }}">
                        </div>
                        <div class="col-md-4">
                            ...
                            <select name="physical_disability" id="physical_disability" class="form-select" required>
                                <option value="">-- Select --</option>
                                <option value="yes" {{ old('physical_disability', $registrationForm->physical_disability) == 'yes' ? 'selected' : '' }}>Yes</option>
                                <option value="no" {{ old('physical_disability', $registrationForm->physical_disability) == 'no' ? 'selected' : '' }}>No</option>
                            </select>
                        </div>
                        <div class="col-md-4">
                            <label for="disability_other" class="form-label">Disability Details</label>
                            <input type="text" name="disability_other" id="disability_other" class="form-control" value="{{ old('disability_other', $registrationForm->disability_other) }}">
                        </div>
                    </div>
                    ...
                    <div class="row mb-3">
                        <div class="col-md-4">
                            ...
                            <select name="permanent_province" id="permanent_province" class="form-select" required>
                                <option value="">-- Select --</option>
                                <option value="Koshi" {{ old('permanent_province', $registrationForm->permanent_province) == 'Koshi' ? 'selected' : '' }}>Koshi</option>
                                <option value="Madhesh" {{ old('permanent_province', $registrationForm->permanent_province) == 'Madhesh' ? 'selected' : '' }}>Madhesh</option>
                                <option value="Bagmati" {{ old('permanent_province', $registrationForm->permanent_province) == 'Bagmati' ? 'selected' : '' }}>Bagmati</option>
                                <option value="Gandaki" {{ old('permanent_province', $registrationForm->permanent_province) == 'Gandaki' ? 'selected' : '' }}>Gandaki</option>
                                <option value="Lumbini" {{ old('permanent_province', $registrationForm->permanent_province) == 'Lumbini' ? 'selected' : '' }}>Lumbini</option>
                                <option value="Karnali" {{ old('permanent_province', $registrationForm->permanent_province) == 'Karnali' ? 'selected' : '' }}>Karnali</option>
                                <option value="Sudurpashchim" {{ old('permanent_province', $registrationForm->permanent_province) == 'Sudurpashchim' ? 'selected' : '' }}>Sudurpashchim</option>
                            </select>
                        </div>
                        <div class="col-md-4">
                            <label for="permanent_district" class="form-label">District <span class="text-danger">*</span></label>
                            <input type="text" name="permanent_district" id="permanent_district" class="form-control" value="{{ old('permanent_district', $registrationForm->permanent_district) }}" required>
                        </div>
                        <div class="col-md-4">
                            <label for="permanent_municipality" class="form-label">Municipality <span class="text-danger">*</span></label>
                            <input type="text" name="permanent_municipality" id="permanent_municipality" class="form-control" value="{{ old('permanent_municipality', $registrationForm->permanent_municipality) }}" required>
                        </div>
                    </div>
                    <div class="row mb-3">
                        <div class="col-md-4">
                            <label for="permanent_ward" class="form-label">Ward No. <span class="text-danger">*</span></label>
                            <input type="text" name="permanent_ward" id="permanent_ward" class="form-control" value="{{ old('permanent_ward', $registrationForm->permanent_ward) }}" required>
                        </div>
                        <div class="col-md-4">
                            <label for="permanent_tole" class="form-label">Tole</label>
                            <input type="text" name="permanent_tole" id="permanent_tole" class="form-control" value="{{ old('permanent_tole', $registrationForm->permanent_tole) }}">
                        </div>
                        <div class="col-md-4">
                            <label for="permanent_house_number" class="form-label">House Number</label>
                            <input type="text" name="permanent_house_number" id="permanent_house_number" class="form-control" value="{{ old('permanent_house_number', $registrationForm->permanent_house_number) }}">
                        </div>
                    </div>
                    <div class="d-flex justify-content-between">
                        <button type="button" class="btn btn-secondary prev-btn">Back</button>
                ...
                <div class="step d-none" id="step4">
                    ...
                    <div class="form-check mb-4">
                        <input type="checkbox" class="form-check-input" id="same_as_permanent" name="same_as_permanent" value="1" {{ old('same_as_permanent', $registrationForm->same_as_permanent) ? 'checked' : '' }}>
                    ...
                    <div class="row mb-3">
                        <div class="col-md-4">
                            ...
                            <select name="mailing_province" id="mailing_province" class="form-select" required>
                                <option value="">-- Select --</option>
                                <option value="Koshi" {{ old('mailing_province', $registrationForm->mailing_province) == 'Koshi' ? 'selected' : '' }}>Koshi</option>
                                <option value="Madhesh" {{ old('mailing_province', $registrationForm->mailing_province) == 'Madhesh' ? 'selected' : '' }}>Madhesh</option>
                                <option value="Bagmati" {{ old('mailing_province', $registrationForm->mailing_province) == 'Bagmati' ? 'selected' : '' }}>Bagmati</option>
                                <option value="Gandaki" {{ old('mailing_province', $registrationForm->mailing_province) == 'Gandaki' ? 'selected' : '' }}>Gandaki</option>
                                <option value="Lumbini" {{ old('mailing_province', $registrationForm->mailing_province) == 'Lumbini' ? 'selected' : '' }}>Lumbini</option>
                                <option value="Karnali" {{ old('mailing_province', $registrationForm->mailing_province) == 'Karnali' ? 'selected' : '' }}>Karnali</option>
                                <option value="Sudurpashchim" {{ old('mailing_province', $registrationForm->mailing_province) == 'Sudurpashchim' ? 'selected' : '' }}>Sudurpashchim</option>
                            </select>
                        </div>
                        <div class="col-md-4">
                            <label for="mailing_district" class="form-label">District <span class="text-danger">*</span></label>
                            <input type="text" name="mailing_district" id="mailing_district" class="form-control" value="{{ old('mailing_district', $registrationForm->mailing_district) }}" required>
                        </div>
                        <div class="col-md-4">
                            <label for="mailing_municipality" class="form-label">Municipality <span class="text-danger">*</span></label>
                            <input type="text" name="mailing_municipality" id="mailing_municipality" class="form-control" value="{{ old('mailing_municipality', $registrationForm->mailing_municipality) }}" required>
                        </div>
                    </div>
                    <div class="row mb-3">
                        <div class="col-md-4">
                            <label for="mailing_ward" class="form-label">Ward No. <span class="text-danger">*</span></label>
                            <input type="text" name="mailing_ward" id="mailing_ward" class="form-control" value="{{ old('mailing_ward', $registrationForm->mailing_ward) }}" required>
                        </div>
                        <div class="col-md-4">
                            <label for="mailing_tole" class="form-label">Tole</label>
                            <input type="text" name="mailing_tole" id="mailing_tole" class="form-control" value="{{ old('mailing_tole', $registrationForm->mailing_tole) }}">
                        </div>
                        <div class="col-md-4">
                            <label for="mailing_house_number" class="form-label">House Number</label>
                            <input type="text" name="mailing_house_number" id="mailing_house_number" class="form-control" value="{{ old('mailing_house_number', $registrationForm->mailing_house_number) }}">
                        </div>
                    </div>
                    <div class="d-flex justify-content-between">
                        <button type="button" class="btn btn-secondary prev-btn">Back</button>
                    ...
                    <div class="row mb-3">
                        <div class="col-md-6">
                            ...
                            <select name="education_level" id="education_level" class="form-select" required>
                                <option value="">-- Select --</option>
                                <option value="Under SLC" {{ old('education_level', $registrationForm->education_level) == 'Under SLC' ? 'selected' : '' }}>Under SLC</option>
                                <option value="SLC/SEE" {{ old('education_level', $registrationForm->education_level) == 'SLC/SEE' ? 'selected' : '' }}>SLC/SEE</option>
                                <option value="+2/Intermediate" {{ old('education_level', $registrationForm->education_level) == '+2/Intermediate' ? 'selected' : '' }}>+2/Intermediate</option>
                                <option value="Bachelor" {{ old('education_level', $registrationForm->education_level) == 'Bachelor' ? 'selected' : '' }}>Bachelor</option>
                                <option value="Master" {{ old('education_level', $registrationForm->education_level) == 'Master' ? 'selected' : '' }}>Master</option>
                                <option value="PhD" {{ old('education_level', $registrationForm->education_level) == 'PhD' ? 'selected' : '' }}>PhD</option>
                            </select>
                        </div>
                        <div class="col-md-6">
                    ...
                    <div class="row mb-3">
                        <div class="col-md-6">
                            ...
                            <select name="has_work_experience" id="has_work_experience" class="form-select" required>
                                <option value="">-- Select --</option>
                                <option value="Yes" {{ old('has_work_experience', $registrationForm->has_work_experience) == 'Yes' ? 'selected' : '' }}>Yes</option>
                                <option value="No" {{ old('has_work_experience', $registrationForm->has_work_experience) == 'No' ? 'selected' : '' }}>No</option>
                            </select>
                        </div>
                        <div class="col-md-6">
                ...
                <div class="step d-none" id="step7">
                    ...
                    <div class="form-check mb-4">
                        <input type="checkbox" class="form-check-input" id="terms_agree" name="terms_agree" {{ old('terms_agree', $registrationForm->terms_agree) ? 'checked' : '' }} required>
